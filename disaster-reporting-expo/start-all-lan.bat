@echo off
title Disaster Reporting - Full Stack Launcher (LAN)
echo ============================================
...
:: Start Laravel in a new window, binding to all interfaces so the phone can reach it
...
:: Start Expo in LAN mode (no tunnel needed, faster)
start "Expo Dev Server" cmd /k "cd /d "%EXPO_DIR%" && npx expo start --lan"
